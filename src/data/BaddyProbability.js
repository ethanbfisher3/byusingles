...
export const getBackgroundColorFromBaddyProbability = (baddyProbability) => {
  ...
  // if (baddyProbability < 0.8) return "#002d5f"
  // if (baddyProbability >= 0.6) return "green"
  // if (baddyProbability >= 0.4) return "yellow"
  // return "red"
}
...
const getBaddyProbability = (event) => {
  ...
  // if (includesText("tradition")) probability += 0.7
